...
-- Widget and layout libraryalsawidget.bar
...
do
    ...
    awesome.connect_signal("debug::error", function (err)
        ...
        in_error = true
awesome.naughty.notify({ preset = naughty.config.presets.critical,
...
{ "edit config", "gedit /home/sam/.config/awesome/rc.lua" },
